import svgPaths from "./svg-eksi5yuzjh";
...
function Attribution() {
  return (
    <div className="absolute bottom-0 content-stretch flex items-center justify-center pb-[32px] pl-[2px] pr-[32px] pt-[3px] right-0" data-name="_attribution">
      <p className="font-['Geist:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#737373] text-[10px]">聊天历史</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex items-center relative shrink-0" data-name="icon">
      <div className="overflow-clip relative shrink-0 size-[12px]" data-name="_canvas-zoomIn-icon">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
          <path d={svgPaths.p1fdf0b80} fill="var(--fill-0, black)" fillOpacity="0.9" id="Vector" />
        </svg>
      </div>
    </div>
  );
      ...
      <div className="overflow-clip relative shrink-0 size-[12px]" data-name="_canvas-zoomOut-icon">
        <div className="absolute inset-[42.17%_0_44.75%_0]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 1.57">
            <path d="M0 0H12V1.57H0V0Z" fill="var(--fill-0, black)" fillOpacity="0.9" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
      ...
      <div className="overflow-clip relative shrink-0 size-[12px]" data-name="_canvas-fitView-icon">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[11.077px] left-1/2 top-1/2 w-[12px]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 11.0768">
            <path d={svgPaths.p2d103880} fill="var(--fill-0, black)" fillOpacity="0.9" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
      ...
      <div className="overflow-clip relative shrink-0 size-[12px]" data-name="_canvas-interactive-unlocked-icon">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[12px] left-1/2 top-1/2 w-[9.143px]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.14288 12">
            <path d={svgPaths.p76dd200} fill="var(--fill-0, black)" fillOpacity="0.9" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Panel() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0" data-name="Panel">
...
function Panel1() {
  return (
    <div className="bg-[#f7f8f7] relative rounded-[8px] shrink-0" data-name="Panel">
      <div className="content-stretch flex gap-[4px] items-center overflow-clip p-[5px] relative rounded-[inherit]">
        <div className="bg-[#f7f8f7] relative rounded-[8px] shrink-0" data-name="Text">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[12px] py-[8px] relative">
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[14px] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.9)]">全部展开</p>
          </div>
        </div>
        <div className="bg-white relative rounded-[8px] shrink-0" data-name="Text">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[12px] py-[8px] relative">
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[14px] not-italic relative shrink-0 text-[12px] text-[rgba(0,0,0,0.9)]">全部折叠</p>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
            ...
            <div className="absolute inset-[56.25%_0_31.25%_0]" data-name="Line">
              <div className="absolute bottom-full left-0 right-0 top-[-16.79%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 2">
                  <line id="Line" stroke="var(--stroke-0, #D4D4D8)" strokeDasharray="3 4" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="1" x2="18" y1="1" y2="12.9099" />
                </svg>
              </div>
            </div>
          </div>
          ...
          <div className="h-[95.28px] relative w-[16px]" data-name="Tale">
            <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[6px] top-1/2" data-name="Circle">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
                <path d={svgPaths.p39fa200} id="Circle" stroke="var(--stroke-0, #D4D4D8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
              </svg>
            </div>
          </div>
        </div>
            ...
            <div className="relative size-full" data-name="Line">
              <div className="absolute inset-[-0.84%_-6.25%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 121.099">
                  <path d={svgPaths.p32df0880} id="Line" stroke="var(--stroke-0, #D4D4D8)" strokeDasharray="3 4" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                </svg>
              </div>
            </div>
          </div>
...
function Group() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] h-[24px] inline-grid ml-0 mt-[25px] place-items-start relative row-1 w-[166.742px]">
            ...
            <div className="absolute inset-[56.25%_0_31.25%_0]" data-name="Line">
              <div className="absolute bottom-full left-0 right-0 top-[-16.79%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 2">
                  <line id="Line" stroke="var(--stroke-0, #D4D4D8)" strokeDasharray="3 4" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="1" x2="10" y1="1" y2="12.9099" />
                </svg>
              </div>
            </div>
          </div>
          ...
          <div className="h-[95.28px] relative w-[16px]" data-name="Cap / Diamond">
            <div className="-translate-x-1/2 -translate-y-1/2 absolute flex items-center justify-center left-1/2 size-[9.998px] top-1/2" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
              <div className="flex-none rotate-45">
                <div className="bg-[#d4d4d8] border-2 border-[#d4d4d8] border-solid rounded-[1px] size-[7.07px]" data-name="Square" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="absolute inset-[55.2%_9.09%_44.8%_-100%]" data-name="Line">
        <div className="absolute inset-[-1px_-4.76%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 2.00195">
            <path d="M1 1.00195L22 1" id="Line" stroke="var(--stroke-0, #D4D4D8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="h-[95px] relative w-[14px]" data-name="Tale">
      <div className="absolute inset-[0_-5.66%_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.7928 95">
          <g id="Tale">
            <path d={svgPaths.p2440ca70} fill="var(--fill-0, #D4D4D8)" id="Line Arrow" />
          </g>
        </svg>
      </div>
    </div>
...
function Group14() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] h-[24px] inline-grid leading-[0] ml-0 mt-[25px] place-items-start relative row-1 w-[166.738px]">
      <div className="col-1 flex h-[16px] items-center justify-center ml-0 mt-[47.64px] relative row-1 w-[119.099px]">
        <div className="-scale-y-100 flex-none h-[16px] rotate-180 w-[119.099px]">
          <div className="relative size-full" data-name="Curve / Dashed">
            <div className="absolute flex inset-0 items-center justify-center">
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0 w-[84px]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 92">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 1">
                  <line id="Line 1" stroke="var(--stroke-0, black)" strokeDasharray="2 2" strokeOpacity="0.1" x2="17" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute left-px size-[5px] top-[-1px]" data-name="dot">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
            <circle cx="2.5" cy="2.5" fill="var(--fill-0, black)" fillOpacity="0.6" id="dot" r="2" stroke="var(--stroke-0, white)" />
          </svg>
        </div>
        <div className="absolute left-px size-[5px] top-[20px]" data-name="dot">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 5">
            <circle cx="2.5" cy="2.5" fill="var(--fill-0, black)" fillOpacity="0.6" id="dot" r="2" stroke="var(--stroke-0, white)" />
          </svg>
        </div>
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 93">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0 w-[84px]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 94">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 95">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
        ...
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 1">
                  <line id="Line 1" stroke="var(--stroke-0, black)" strokeOpacity="0.1" x2="17" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0 w-[84px]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 96">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
            ...
            <div className="-translate-y-1/2 absolute h-[16px] left-0 right-[16px] top-1/2" data-name="Path">
              <div className="absolute inset-[56.25%_0_31.25%_0]" data-name="Line">
                <div className="absolute bottom-full left-0 right-0 top-[-100%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 2">
                    <line id="Line" stroke="var(--stroke-0, #D4D4D8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="1" x2="10" y1="1" y2="3" />
                  </svg>
                </div>
              </div>
            </div>
                      ...
                      <div className="relative size-full" data-name="Line">
                        <div className="absolute inset-[-1.3%_-6.25%]">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 79">
                            <path d={svgPaths.p3b5d9f40} id="Line" stroke="var(--stroke-0, #D4D4D8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                          </svg>
                        </div>
                      </div>
                    </div>
                ...
                <div className="relative size-[16px]" data-name="Head B">
                  <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[10px] left-[calc(50%-0.1px)] top-1/2 w-[5.793px]" data-name="Line Arrow">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.79274 9.99985">
                      <path d={svgPaths.pe698280} fill="var(--fill-0, #D4D4D8)" id="Line Arrow" />
                    </svg>
                  </div>
                </div>
              </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[84px]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 97">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
...
function Flow() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-[294px] top-[58px]" data-name="flow">
      <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Card">
        <div className="bg-[rgba(158,214,74,0.2)] content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative rounded-[8px] shrink-0" data-name="Chat History1">
          <div className="relative shrink-0 size-[16px]" data-name="user">
            <div className="absolute flex inset-[14.58%_20.83%] items-center justify-center">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 87">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 88">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 89">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 90">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
      ...
      <div className="h-[21px] relative shrink-0 w-[7px]" data-name="Component 91">
        <div className="-translate-y-1/2 absolute flex h-[17px] items-center justify-center left-[4px] right-[3px] top-[calc(50%+2px)]">
          <div className="-rotate-90 flex-none h-px w-[17px]">
            <div className="relative size-full">
              <div className="absolute inset-[-1px_0_0_0]">
...
export default function Canvas() {
  return (
    <div className="bg-size-[10px_10px,auto_auto] bg-top-left relative rounded-[16px] size-full" data-name="Canvas" style={{ backgroundImage: `url('${imgCanvas}'), linear-gradient(90deg, rgb(247, 248, 247) 0%, rgb(247, 248, 247) 100%)` }}>
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[17px]" />
    </div>
  );
}
...
// Inline SVG brand logos — paths sourced from Simple Icons (CC0 / public domain)
// Colors use each brand's official palette. Theme-adaptive logos use currentColor.
...
export function LetterBadge({ letter, bg, size = 16, className }: { letter: string; bg: string; size?: number; className?: string }) {
  return (
    <div
      className={`flex items-center justify-center text-white flex-shrink-0 ${className || ''}`}
      style={{ width: size, height: size, borderRadius: size * 0.25, background: bg, fontSize: size * 0.45, fontWeight: 700, lineHeight: 1 }}
    >
      {letter}
    </div>
  );
...
// ── Anthropic / Claude  (theme-adaptive: dark on light, light on dark) ──
export function AnthropicLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className || 'text-[#B8865A] dark:text-[#D4A27F]'}>
...
// ── Google (official multicolor — fixed) ──
...
// ── Microsoft / Bing (official four-color — fixed) ──
...
export function GitHubLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className || 'text-[#24292f] dark:text-[#f0f0f0]'}>
...
export function NotionLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className || 'text-[#000000] dark:text-[#ffffffee]'}>
...
// ── Obsidian (official purple #7C3AED → actual #A88BFA / #7C3AED) ──
export function ObsidianLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
      <path d="M16.567 1.29l-8.1 3.18c-.29.12-.53.34-.67.62L2.857 14.87c-.15.31-.17.67-.06.99l2.46 7.12c.15.42.5.74.93.85.11.03.22.04.33.04.33 0 .64-.13.87-.37l4.09-4.2 4.73 3.6c.23.17.5.27.79.27.12 0 .25-.02.37-.06.4-.12.72-.43.85-.83l5.33-17.66c.11-.37.05-.77-.17-1.09-.22-.32-.57-.52-.95-.55l-6.85-.66z" fill="#A88BFA"/>
      <path d="M7.38 21.2l-2.04-5.9 4.3-8.6.34 9.47z" fill="#7C3AED"/>
      <path d="M17.2 21.38l-4.47-3.4-.38-10.7 8.1 1.42z" fill="#6633CC"/>
    </svg>
  );
}

// ── Joplin (official blue #1071D3) ──
export function JoplinLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#1071D3" className={className}>
...
export function AWSLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
...
export function OllamaLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className || 'text-[#1a1a1a] dark:text-[#f0f0f0]'}>
...
export function MistralLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
...
// ── Gemini (official gradient blue→purple) ──
export function GeminiLogo({ size = 16, className }: LogoProps) {
  const id = `gemini-${size}`;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
      <path d="M12 24A14.3 14.3 0 0 0 0 12 14.3 14.3 0 0 0 12 0a14.3 14.3 0 0 0 12 12 14.3 14.3 0 0 0-12 12z" fill={`url(#${id})`}/>
      <defs><linearGradient id={id} x1="0" y1="0" x2="24" y2="24"><stop stopColor="#4285F4"/><stop offset="1" stopColor="#886FBF"/></linearGradient></defs>
    </svg>
  );
}

// ── Perplexity (official teal #20808D) ──
export function PerplexityLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#20808D" className={className}>
...
export function HuggingFaceLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#FFD21E" className={className}>
...
// ── 语雀 Yuque (official green #36B37E) ──
export function YuqueLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#36B37E" className={className}>
...
// ── 阿里云 Alibaba Cloud (official orange #FF6A00) ──
export function AlibabaCloudLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#FF6A00" className={className}>
...
// ── WebDAV (cloud sync — theme-adaptive) ──
export function WebDAVLogo({ size = 16, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#4A90D9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/>
    </svg>
  );
}

// ── Qwen / 通义 (official purple) ──
export function QwenLogo({ size = 16, className }: LogoProps) {
  return <LetterBadge letter="Q" bg="#7C3AED" size={size} className={className} />;
}

// ── iFlow (yellow lightning — distinct branded icon) ──
export function IFlowLogo({ size = 16, className }: LogoProps) {
  return (
    <div
      className={`flex items-center justify-center flex-shrink-0 ${className || ''}`}
      style={{ width: size, height: size, borderRadius: size * 0.25, background: '#eab308' }}
    >
...
// ── Kimi / Moonshot (black with white K — theme-adaptive bg) ──
export function KimiLogo({ size = 16, className }: LogoProps) {
  return (
    <div
      className={`flex items-center justify-center text-white flex-shrink-0 bg-[#1a1a2e] dark:bg-[#f0f0f0] dark:text-[#1a1a2e] ${className || ''}`}
      style={{ width: size, height: size, borderRadius: size * 0.25, fontSize: size * 0.5, fontWeight: 700, lineHeight: 1 }}
    >
      K
    </div>
  );
...
const BRAND_LOGO_MAP: Record<string, (props: LogoProps) => React.JSX.Element> = {
  ...
  'system-ocr': (props: LogoProps) => <LetterBadge letter="OCR" bg="#374151" size={props.size} className={props.className} />,
  mineru: (props: LogoProps) => <LetterBadge letter="U" bg="#6366f1" size={props.size} className={props.className} />,
  doc2x: (props: LogoProps) => <LetterBadge letter="2x" bg="#ef4444" size={props.size} className={props.className} />,

  // Other
  grok: (props: LogoProps) => <LetterBadge letter="X" bg="#000000" size={props.size} className={props.className} />,
  grokx: (props: LogoProps) => <LetterBadge letter="X" bg="#000000" size={props.size} className={props.className} />,
  bolt: (props: LogoProps) => <LetterBadge letter="b" bg="#000000" size={props.size} className={props.className} />,
  notebooklm: (props: LogoProps) => <LetterBadge letter="NL" bg="#f59e0b" size={props.size} className={props.className} />,
  tokenflux: (props: LogoProps) => <LetterBadge letter="TF" bg="#7c3aed" size={props.size} className={props.className} />,
  lanyun: (props: LogoProps) => <LetterBadge letter="蓝" bg="#06b6d4" size={props.size} className={props.className} />,
  '302ai': (props: LogoProps) => <LetterBadge letter="302" bg="#f97316" size={props.size} className={props.className} />,
  'mcp-router': (props: LogoProps) => <LetterBadge letter="MR" bg="#374151" size={props.size} className={props.className} />,
  cherry: (props: LogoProps) => <LetterBadge letter="C" bg="#10b981" size={props.size} className={props.className} />,
  'cherry-in': (props: LogoProps) => <LetterBadge letter="🍒" bg="#10b981" size={props.size} className={props.className} />,
};

/** Get a brand logo component by id. Falls back to a letter badge. */
export function BrandLogo({ id, fallbackLetter, fallbackColor, size = 16, className }: {
  id: string;
  ...
  if (fallbackLetter) return <LetterBadge letter={fallbackLetter} bg={fallbackColor || '#6b7280'} size={size} className={className} />;
  return null;
}
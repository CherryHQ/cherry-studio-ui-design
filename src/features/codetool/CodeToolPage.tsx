...
import { Button, Input, SearchInput, Textarea, EmptyState, BrandLogo, Popover, PopoverTrigger, PopoverContent , Checkbox} from '@cherry-studio/ui';
            ...
            <div className="flex items-center justify-between px-4 h-11 flex-shrink-0 border-b border-border/15">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-muted-foreground/50 ml-1.5">{selectedTool.version}</span>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 scrollbar-hide">
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-accent/5 border border-border/10">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-muted-foreground/40">{selectedTool.desc}</div>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-xs px-1.5 py-0.5 rounded bg-accent/50 text-muted-foreground/50">{selectedTool.version}</span>
                    <span className="text-xs px-1.5 py-0.5 rounded bg-accent/50 text-muted-foreground/50">
              ...
              <label className="flex items-center gap-2 cursor-pointer group">
                <Checkbox checked={config.checkUpdates} onCheckedChange={() => updateConfig(selectedCli, { checkUpdates: !config.checkUpdates })} className="flex-shrink-0" />

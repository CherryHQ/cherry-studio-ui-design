...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn(
        "group/tabs flex gap-2 tracking-tight data-[orientation=horizontal]:flex-col",
        className
      )}
      {...props}
    />
...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "relative inline-flex h-full flex-1 items-center justify-center gap-1.5 rounded-[8px] border border-transparent px-3 py-2 text-[13px] font-semibold whitespace-nowrap text-muted-foreground tracking-tight transition-[color,box-shadow,opacity] overflow-hidden group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-30 group-data-[variant=line]/tabs-list:data-[state=active]:shadow-none dark:text-muted-foreground dark:hover:text-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",

...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div data-slot="error-boundary" className={cn('flex items-center justify-center h-full w-full bg-background tracking-tight', this.props.className)}>
          <div className="flex flex-col items-center gap-4 max-w-[360px] text-center px-6">
            ...
            <div>
              <h3 className="text-[13px] text-foreground/80 mb-1 font-medium">
                {'\u9875\u9762\u6e32\u67d3\u51fa\u9519'}
              </h3>
            ...
            {this.state.error && (
              <div className="w-full bg-foreground/[0.03] border border-foreground/[0.06] rounded-[var(--radius-button)] px-3 py-2 text-left">
                <p className="text-xs text-foreground/25 mb-1 font-medium">
                  {'\u9519\u8bef\u8be6\u60c5'}
                </p>
            ...
            <Button
              ...
              className="gap-1.5 bg-foreground/[0.06] hover:bg-foreground/[0.1] text-foreground/60 text-[11px]"
            >
              <RotateCcw size={12} />
              {'\u91cd\u65b0\u52a0\u8f7d'}
            </Button>

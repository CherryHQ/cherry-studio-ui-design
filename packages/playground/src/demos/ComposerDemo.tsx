...
/>`}>
        <div className="max-w-lg border rounded-[12px] overflow-hidden bg-background">
          ...
          <Composer
            ...
            leftActions={
              <div className="flex items-center gap-0.5">
                <Button variant="ghost" className="p-1 rounded-[12px] text-muted-foreground hover:text-foreground hover:bg-accent/20 transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50">
                  <Plus size={14} />
                </Button>
                <Button variant="ghost" className="p-1 rounded-[12px] text-muted-foreground hover:text-foreground hover:bg-accent/20 transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50">
                  <Image size={14} />
            ...
            rightInfo={
              <Badge variant="outline" className="text-xs h-5">GPT-4o</Badge>
            }
          />
        </div>
      </Section>

...
<div className="flex items-center space-x-2">
  ...
  <Label htmlFor="terms">Accept terms and conditions</Label>
      ...
      <Section title="Checkbox — Practical Settings">
        <div className="rounded-[12px] border p-4 max-w-sm space-y-4">
        ...
        <RadioGroup defaultValue="gpt4o" className="grid grid-cols-3 gap-3 max-w-lg">
          {[
            ...
            <Label
              ...
              className="flex flex-col items-center justify-center rounded-[12px] border border-muted bg-transparent p-4 hover:bg-accent hover:text-accent-foreground cursor-pointer has-[:checked]:border-primary has-[:checked]:ring-1 has-[:checked]:ring-primary/20 [&:has(:checked)]:border-primary"
            >
      ...
      <Section title="Switch — Practical Settings Row">
        <div className="max-w-sm space-y-4 rounded-[12px] border p-4">
          {[

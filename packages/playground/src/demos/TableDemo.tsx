        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Context</TableHead>
              <TableHead>
                <Button variant="ghost" className="flex items-center gap-1 hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50" onClick={handleSort}>

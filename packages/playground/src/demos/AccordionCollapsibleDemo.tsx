    ...
    <AccordionContent>Answer.</AccordionContent>
      ...
      <Section title="Collapsible">
        <Collapsible className="w-full max-w-lg space-y-2">
          ...
          <div className="rounded-md border px-4 py-2 text-sm font-mono">@cherry-studio/ui</div>
          <CollapsibleContent className="space-y-2">
            <div className="rounded-md border px-4 py-2 text-sm font-mono">@cherry-studio/core</div>
            <div className="rounded-md border px-4 py-2 text-sm font-mono">@cherry-studio/cli</div>
          </CollapsibleContent>
        </Collapsible>
      </Section>

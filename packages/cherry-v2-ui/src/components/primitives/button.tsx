  ...
  ),
  {
    variants: {
      ...
      size: {
        ...
        // Sizes added for cherry-studio-ui-design consumers — kept
        // out of the upstream v2 button.tsx but added here so the
        // existing call sites (size="xs" / "inline" / "icon-xs")
        // keep rendering at their intended density.
        xs: 'h-auto gap-1 px-2 py-1 text-[11px]',
        inline: 'h-auto px-1.5 py-0.5 text-xs has-[>svg]:px-1.5',
        icon: 'size-9',
        'icon-sm': 'size-7',
        'icon-xs': 'size-5',
        'icon-lg': 'size-10'
